...
$csrf = csrf_token();
render_header(lang_text('pages.ritual.meta.v3.title', 'Just One KISS — What Is Just One KISS?'), lang_text('pages.ritual.meta.v3.description', 'A fan-built KISS tribute gathering for July 25, 2026 at Cycle Moore Legacy: free admission, campground energy, favorite songs, shared stories, and big rock attitude.'));
...
<main id="main">
  ...
  <section class="subhero section-shell" aria-labelledby="page-title">
    ...
    <div class="cta-row"><a class="button button--fire" href="<?= e(page_url('/july-25-2026/')) ?>#updates"><?= lang_editable('pages.ritual.v3.cta.free_show', 'Get July 25 updates') ?></a><a class="button button--chrome" href="<?= e(page_url('/spectacle/')) ?>"><?= lang_editable('pages.ritual.v3.cta.spectacle', 'Keep the mystery') ?></a></div>
  ...
  <section class="section-shell proof-section" aria-labelledby="identity-title">
    ...
    <p class="section-lede"><?= lang_editable('pages.ritual.v3.identity.lede', 'This page does not need to spoil the show. The point is simpler: people still care, the songs still travel, the stories still matter, and July 25 gives everyone a place to gather around that feeling.') ?></p>
  ...
  <section class="section-shell spectacle-section" aria-labelledby="not-title">
    ...
    <p class="section-lede"><?= lang_editable('pages.ritual.v3.not.body', 'It is a free show day for fans. The homepage gives the essentials, the FAQ gives the practical notes, and the rest is for everyone who decides to be there when July 25 arrives.') ?></p>
  </section>
