...
$csrf = csrf_token();
render_header(lang_text('pages.faq.meta.v3.title', 'Just One KISS — FAQ and Show Notes'), lang_text('pages.faq.meta.v3.description', 'Answers for the free July 25, 2026 Just One KISS show at Cycle Moore Legacy: admission, arrival, camping, parking, updates, photos, and what fans should know.'));
render_notice($formResult);
$faqs = [
 ['pages.faq.v3.q1','pages.faq.v3.a1','Is the July 25 show really free?','Yes. Show admission is free. No ticket is required. Joining the update list is appreciated because it helps fans catch reminders, arrival notes, and event-day posts.'],
 ...
 ['pages.faq.v3.q6','pages.faq.v3.a6','What kind of night is this?','A fan-centered KISS tribute gathering: free admission, campground atmosphere, people showing up for the songs they love, and a shared reason to make July 25 feel bigger than an ordinary Saturday.'],
 ...
 ['pages.faq.v3.q9','pages.faq.v3.a9','Can I bring a chair or blanket?','Outdoor comfort items are a good idea unless event-day posts say otherwise. Watch for updates closer to July 25 so you know what fits best around the pavilion area.'],
 ...
 ['pages.faq.v3.q15','pages.faq.v3.a15','How do I ask something not listed here?','Use the contact page. Send the question, pick the closest topic, and the show can route it to the right person before July 25.'],
...
<main id="main">
  ...
  <section class="subhero section-shell" aria-labelledby="page-title">
    ...
    <p class="hero__lede"><?= lang_editable('pages.faq.v3.hero.lede', 'Here is the practical stuff and the fan stuff for July 25 at Cycle Moore Legacy. The rest is better discovered in person, surrounded by people who came because KISS still means something to them.') ?></p>
    ...
    <?php render_page_image('road-case-vault-bg.webp', lang_text('pages.faq_disclaimer.image.1.alt', 'Hero: fan question cards and July 25 notes arranged on a road case.')); ?>
  </section>
