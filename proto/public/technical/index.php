...
<main id="main">
  ...
  <section class="subhero section-shell" aria-labelledby="page-title">
    ...
    <div class="cta-row">
      <a class="button button--fire" href="<?= e(page_url('/july-25-2026/')) ?>#updates"><?= lang_editable('pages.technical.cta.updates', 'Join the July 25 update list') ?></a>
  ...
  <section class="section-shell proof-section" aria-labelledby="technical-info-title">
    ...
    <div class="proof-grid">
      <article><h3><?= lang_editable('pages.technical.info.1.title', 'Admission') ?></h3><p><?= lang_editable('pages.technical.info.1.body', 'The July 25, 2026 event is a free show. No ticket is required; RSVP is appreciated.') ?></p></article>
