...
This folder is the self-contained working home for planning, producing, reviewing, publishing, measuring, and retiring the next Just One KISS campaign. Start with [`MARKETING_CAMPAIGN_CANON.md`](MARKETING_CAMPAIGN_CANON.md). It is the campaign-level Single Source of Truth (SSOT).
...
1. Read the canon sections **Status banner**, **Fact registry**, **Open decisions**, and **Release gates**.
2. Confirm that the fact file and canon agree.
3. Choose one audience, one funnel job, one lead creative family, one proof, and one action.
4. Create a brief from `../marketing/templates/CAMPAIGN_BRIEF_TEMPLATE.md` or `CAMPAIGN_PIECE_TEMPLATE.md` in `briefs/`.
5. Assign rights IDs before production and tracking IDs before publication.
6. Produce a canonical master, then intentional placement adaptations.
7. Complete the production checklist and create an immutable release record.
8. Publish, verify, monitor, expire, and record learning.
